            ...
            <div className={Styles.registerform}>
                ...
                <form className='form' onSubmit={e => onSubmit(e)}>
                    ...
                    <div className="form-group">
                        ...
                        <small className='form-text' className={Styles.info}>Enter number without +91</small>
                    </div>
                    <div className="form-group">
                        ...
                        <small className='form-text' className={Styles.info}>Enter password of length 6 and above</small>
                    </div>
                    <div className="form-group">
